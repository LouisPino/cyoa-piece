...
const batIsoArr = [
    ...
    "To thank you for your help, let me give you some advice on the next leg of your travels: the GRAND TELEPORTER that you’re about to use is a little bit broken. It might separate the two of you if you go at the same time. ",
...
const ratsArr = [
    ...
    "Absolutely",
    " *gasp* This is it! The glorious final product I will use to enter the festival! Woohoo!",
    "To thank you for your help, let us give you some advice on the next leg of your travels: the GRAND TELEPORTER that you’re about to use is a little bit broken. It might separate the two of you if you go at the same time. ",
    "To get there successfully, make sure you jump in one at a time. Good luck!",
    "What a lovely experience. ",
    "According to our map, there is treasure to be found amidst the stars or deep in the ocean! The Grand Teleporter will bring us half way there……..",
    "What about the remaining half?",
